/* Generic scripts to check forms */
...
/* 
 * Method called by hasInput(), checks a group of radiobuttons for a value
 * 
 * @param	radioGroup	id of group of radiobuttons to check
 * @return	true if there is value, false if not
 */
...
/*
 * Checks a Dutch postcode 
 * 
 * @param	str	String containing a postcode
 * @return	true if postcode is OK, false if otherwise
 */
 ...
 * @retrun	true if email is valid, false if otherwise
 */
